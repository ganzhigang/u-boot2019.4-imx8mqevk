cmd_spl/lib/libfdt/fdt_region.o := aarch64-poky-linux-gcc -Wp,-MD,spl/lib/libfdt/.fdt_region.o.d  -nostdinc -isystem /home/duxy/opt_warrior/sysroots/x86_64-pokysdk-linux/usr/lib/aarch64-poky-linux/gcc/aarch64-poky-linux/8.3.0/include -Iinclude   -I./arch/arm/include -include ./include/linux/kconfig.h -D__KERNEL__ -D__UBOOT__ -DCONFIG_SPL_BUILD -Wall -Wstrict-prototypes -Wno-format-security -fno-builtin -ffreestanding -std=gnu11 -fshort-wchar -fno-strict-aliasing -fno-PIE -Os -fno-stack-protector -fno-delete-null-pointer-checks -fmacro-prefix-map=./= -g -fstack-usage -Wno-format-nonliteral -Werror=date-time --sysroot=/home/duxy/opt_warrior/sysroots/aarch64-poky-linux -ffunction-sections -fdata-sections -I./scripts/dtc/libfdt -D__ARM__ -mstrict-align -ffunction-sections -fdata-sections -fno-common -ffixed-r9 -fno-common -ffixed-x18 -pipe -march=armv8-a -mgeneral-regs-only -D__LINUX_ARM_ARCH__=8    -D"KBUILD_STR(s)=$(pound)s" -D"KBUILD_BASENAME=KBUILD_STR(fdt_region)"  -D"KBUILD_MODNAME=KBUILD_STR(fdt_region)" -c -o spl/lib/libfdt/fdt_region.o lib/libfdt/fdt_region.c

source_spl/lib/libfdt/fdt_region.o := lib/libfdt/fdt_region.c

deps_spl/lib/libfdt/fdt_region.o := \
...
spl/lib/libfdt/fdt_region.o: $(deps_spl/lib/libfdt/fdt_region.o)
